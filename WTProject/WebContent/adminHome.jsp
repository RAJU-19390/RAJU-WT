...
<body>
<center> <img src="sru.jfif" width="100" height="100">
</center>
<div class="w3-container">
  <div class="w3-bar w3-black">
    <button class="w3-bar-item w3-button tablink w3-red" onclick="openCity(event,'London')">Add New Student</button>
    <button class="w3-bar-item w3-button tablink w3-black" onclick="openCity(event,'Paris')">Insert New Result</button>
    <button class="w3-bar-item w3-button tablink w3-black" onclick="openCity(event,'Tokyo')">Registered Students</button>
     <button class="w3-bar-item w3-button tablink w3-black" onclick="openCity(event,'Tokyo1')">All Student Result</button>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" action="insertNewResult.jsp" method="post">
                                ...
                                <div class="form-group row">
                                    <label for="email_address" class="col-md-4 col-form-label text-md-right">Design & Analysis of algorithms:</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="user_name" class="col-md-4 col-form-label text-md-right">Computer Networks:</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="phone_number" class="col-md-4 col-form-label text-md-right">Web Technologies:</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="present_address" class="col-md-4 col-form-label text-md-right">Design & Analysis of algorithms LAB:</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">Computer Networks LAB:</label>
                                    <div class="col-md-6">
                                 ...
                                 <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">Web Technologies LAB:</label>
                                    <div class="col-md-6">
                                 ...
                                 <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">Artificial Intelligence:</label>
                                    <div class="col-md-6">
...
<section>
    ...
    <table cellpadding="0" cellspacing="0" border="0">
      <thead>
        <tr>
          ...
          <th>Design & analysis of algorithms LAB</th>
          <th>Computer Networks LAB</th>
          <th>Web Technologies LAB</th>
  ...
  <div class="tbl-content">
    ...
    <hr class="new1">
  <center><h5>Note: Any errors occur then contact by mailid:www.rajuboda333@gmail.com.
Designed & Developed by RAJU B.TECH</h5></center>
  <hr class="new1">
<center><h5>All Right Reserved @ BTech Days :: 2002-2022</h5></center> 
  <hr class="new1">
<br>
</body>
</html>