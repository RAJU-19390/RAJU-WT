...
<center><img src="sru.jfif" width="150" height="150">
</center>
...
body{
  ...
  <div class="tbl-header">
    <table cellpadding="0" cellspacing="0" border="0">
      <thead>
        <tr>
          <th>institution Name: SR University</th>
...
<body>
  <table>
    ...
    <tbody>
      <tr>
        <td>RA18101</td>
        <td colspan="2">Design & Analysis of Algorithms </td>
        <td>Theory</td>
        <td>100</td>
        <td> 30 </td>
      ...
      <tr>
        <td>RA18103</td>
        <td colspan="2">Web Tecnologies </td>
        <td>Theory</td>
        <td>100</td>
        <td> 30 </td>
      ...
      <tr>
        <td>RA18101</td>
        <td colspan="2">Design & Analysis of Algorithms LAB</td>
        <td>LAB</td>
        <td>100</td>
        <td> 30 </td>
      ...
      <tr>
        <td>RA18101</td>
        <td colspan="2">Computer Networks LAB</td>
        <td>LAB</td>
        <td>100</td>
        <td> 30 </td>
      ...
      <tr>
        <td>RA18152</td>
        <td colspan="2">Web Tecnologies LAB</td>
        <td>LAB</td>
        <td>100</td>
        <td>30</td>
...
Designed & Developed by RAJU B.TECH</h6></center>
  <hr class="new1">
<center><h6>All Right Reserved @ RAJU B.TECH :: 2002-2022</h6></center> 
  <hr class="new1">
</body>
<%}
else
